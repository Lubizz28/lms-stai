      ...
      <Card>
        ...
        <CardBody>
          {thread.isLocked ? (
            ...
            <form onSubmit={handleSendMainReply} className="flex flex-col gap-4">
              <textarea
                className="form-textarea"
                rows={4}
              ...
              <div className="flex justify-between items-center">
                <span style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)' }}>
                  Partisipasi Anda akan otomatis tercatat dalam rekam jejak aktivitas belajar.
                </span>

                <Button variant="primary" type="submit" icon={Send} isLoading={isSubmitting}>
